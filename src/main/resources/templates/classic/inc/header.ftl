        ...
        <nav class="navbar" role="navigation">
            ...
            <div class="collapse navbar-collapse">
				...
				<#if profile??>
                    <@controls name="post">
                        <li>
                            <a href="${base}/post/editing" class="plus"><i class="icon icon-note"></i> 创建文章</a>
                        </li>
                    </@controls>
                    <li class="dropdown">
				...
				<#else>
                    <li><a href="http://wlink.wulian.cc/platform/pages/third/wx_duola_register.html" class="btn btn-default btn-sm signup">微信通道</a></li>
                    <#if mark??>
